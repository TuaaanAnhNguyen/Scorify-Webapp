    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-8">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Chào mừng quay lại</h1>
            ...
            >
              <div className="flex items-center gap-2">
                <div className={`p-2 rounded-lg ${role === "teacher" ? "bg-[#F05123]" : "bg-gray-200"}`}>
                  <GraduationCap className={`size-5 ${role === "teacher" ? "text-white" : "text-gray-600"}`} />
                </div>
                <div className="text-left">
                  <div className="font-semibold text-gray-900 text-sm">Giáo viên</div>
                </div>
              </div>
            </button>
            <button
            ...
            >
              <div className="flex items-center gap-2">
                <div className={`p-2 rounded-lg ${role === "student" ? "bg-[#F05123]" : "bg-gray-200"}`}>
                  <User className={`size-5 ${role === "student" ? "text-white" : "text-gray-600"}`} />
                </div>
                <div className="text-left">
                  <div className="font-semibold text-gray-900 text-sm">Học sinh</div>
                </div>
              </div>
            </button>
            <button
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center">
              <input type="checkbox" className="size-4 text-[#F05123] border-gray-300 rounded" />
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-600">
            Chưa có tài khoản?{" "}
            <Link to="/signup" className="text-[#F05123] hover:text-[#D9471E] font-medium">
              Đăng ký
            </Link>
          </p>
        </div>
